...
if markdown is not None and pygments is not None:
    # starting from this itempost and modified to support current markdown extensions API
    # https://zerokspot.com/weitem/2008/06/18/syntax-highlighting-in-markdown-with-pygments/
